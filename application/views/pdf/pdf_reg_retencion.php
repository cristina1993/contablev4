<section class="content" style="margin-top:-30px">
    ...
    <table  width="110%">
        ...
        <tr>
            <th width="120%" class="titulo_p" style="text-align: center;">COMPROBANTE DE RETENCION</th>
        </tr>
        ...
        <tr>
            ...
            <td width="40%" ><?php echo utf8_encode('N°: ')?>
        ...
        <tr>
            <td width="48%" valign="bottom">
                <table id="encabezado1" width="145%">
                    <tr>
                        <td>
