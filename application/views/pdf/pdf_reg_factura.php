<section class="content">
            ...
            <td colspan="2">
                <table id="encabezado1" width="100%" style="margin-right: 0px;">
                    <tr>
                        <td> </td>
                        <td> </td>
                        <td width="15%"><img src="<?php echo base_url().'imagenes/'.$factura->emp_logo?>" width="130px"
                                height="70px"></td>
                    </tr>
                </table>
            </td>
    ...
    <table width="105%">
        <tr>
            <td width="500%">
                <table id="encabezado3" width="110%">
                    <tr>
                        <td width="60px">
                    ...
                    <tr>
                        ...
                        <td colspan="2"><label class="digito" style="font-weight: normal;">
                    ...
                    <tr>
                        ...
                        <td colspan="2"> <label style="font-weight: normal;">
                    ...
                    <tr>
                        ...
                        <td width="60px" class="digito"> <strong style="color: black;">
                                <?php echo utf8_encode('ASIENTO:') ?> </strong>
                        </td>
                        <td  width="0px" class="digito"><label><?php echo $asientos->con_asiento?> </label> </td>
                ...
                ?>
                        <td > <strong> <?php echo utf8_encode('RETENCION:') ?> </strong>
                            <label class="digito"><?php echo $ret->ret_numero?> </label>
                        </td>
                        <?php 
                }
                ?>
        ...
        $th = 0;
         ...
         while ($n < count($cuentas)) {
            ...
            $rst_cuentas1 = $plan_cuentas_model->lista_un_plan_cuentas_codigo_id($cta[0]);
            $vdebe=0;
            $vhaber=0;
            if ($cta[2] == 0) {
